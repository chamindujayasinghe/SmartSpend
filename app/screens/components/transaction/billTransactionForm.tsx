    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        <View style={styles.topSelectors}>
          ...
          >
            <AppText style={{ color: titlecolor }}>Date</AppText>
            <AppText style={{ color: secondarycolormode }}>
          ...
          <TouchableOpacity
            ...
            style={[styles.selectorRow, { borderBottomColor: textinputcolor }]}
          >
            <AppText style={{ color: titlecolor }}>Account</AppText>
            <AppText style={{ color: secondarycolormode }}>
        ...
        {items.map((item, index) => (
          <View key={index} style={styles.cardContainer}>
            {/* Product Card */}
            <View style={[styles.productCard, { borderColor: textinputcolor }]}>
              <View style={styles.cardRow}>
                <TextInput
                  style={[styles.productInput, { color: titlecolor }]}
...
const styles = StyleSheet.create({
  ...
  cardContainer: {
    flexDirection: "row",
    marginBottom: 15,
    alignItems: "stretch", // Ensures children take the same height
  },
  productCard: {
  ...
  productInput: { flex: 2, fontSize: 16, fontWeight: "500" },
  amountInput: { flex: 1, textAlign: "right", fontSize: 16 },
